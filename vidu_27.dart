...
void main() {
  ...
  var fn = createFullName(ho: "Nguyen", chuLot: "Thanh", ten: "Danh");
  print(fn);

  var fn2 = createFullName(chuLot: "Thanh", ten: "Danh", ho: "Nguyen");
  print(fn2);

  var fn3 = createFullName(chuLot: "Thanh", ten: "Danh");
  print(fn3);
